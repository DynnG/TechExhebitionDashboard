...
export function StatCard({
  ...
  return (
    <BorderGlow glowColor={glowColor} borderRadius="12px" className="w-full">
      <div className="p-5 min-h-[124px] flex items-start justify-between relative overflow-hidden font-manrope bg-white rounded-[12px] shadow-[0_2px_16px_rgba(0,0,0,0.05)] border-[1.5px] border-[#D8D2C8]">
        ...
        <div className="w-11 h-11 rounded-[10px] bg-[#046241]/10 border border-[#046241]/20 flex items-center justify-center text-[#046241] shrink-0">
          <Icon className="w-5 h-5 text-[#046241]" />
        </div>
      </div>
    </BorderGlow>
  );
